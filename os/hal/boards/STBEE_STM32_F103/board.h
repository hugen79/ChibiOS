 ...
 * Board identifier.
 */
#define BOARD_STBEE_STM32_F103
#define BOARD_NAME              "Strawberry Linux STbee"
 ...
 * https://strawberry-linux.com/pub/stbee-sch.pdf
 */
 ...
 * Port D setup.
 * Everything input with pull-up except:
 * PD3  - Push Pull output  (USB switch).
 * PD4  - Push Pull output  (LED).
 * PD0  - Normal input (XTAL).
 * PD1  - Normal input (XTAL).
 */
#define VAL_GPIODCRL            0x88833844      /*  PD7...PD0 */
 ...
 * Everything input with pull-up except:
 */
#define VAL_GPIOFCRL            0x88888888      /*  OF7...OF0 */
#define VAL_GPIOFCRH            0x88888888      /* OF15...OF8 */
