...
/*
 * Setup for the Strawberry Linux STbee mini
 */

/*
 * Board identifier.
 */
#define BOARD_STBEE_MINI_STM32_F103
#define BOARD_NAME              "Strawberry Linux STbee mini"
 ...
 * https://strawberry-linux.com/pub/sbee-mini-sch.pdf
 */
 ...
 * PA13 - Push Pull output  (LED1).
 * PA14 - Push Pull output  (USB switch).
 * PA15 - Push Pull output  (LED2).
 */
#define VAL_GPIOACRL            0x88884B88      /*  PA7...PA0 */
#define VAL_GPIOACRH            0x333884B8      /* PA15...PA8 */
